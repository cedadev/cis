...
from jasmin_cis.test.test_files.integration_test_data import cis_test_files
...
class TestNCAR_NetCDF_RAF(ProductTests, unittest.TestCase):
    ...
    def test_can_concatenate_files_with_different_time_stamps(self):
        ...
        import numpy as np
        from jasmin_cis.test.test_files.integration_test_data import valid_GASSP_station_files_with_different_timestamps,\
    ...
    def test_can_concatenate_aircraft_files(self):
        from jasmin_cis.data_io.read import read_data
        from jasmin_cis.test.test_files.integration_test_data import valid_GASSP_aircraft_files_with_different_timestamps,\
...
class TestNCAR_NetCDF_RAF_get_file_type_error(unittest.TestCase):
    ...
    def test_WHEN_file_is_GASSP_THEN_no_errors(self):
        from jasmin_cis.test.test_files.integration_test_data import valid_GASSP_station_filename
    ...
    def test_WHEN_file_is_NCAR_RAF_THEN_no_errors(self):
        from jasmin_cis.test.test_files.integration_test_data import valid_NCAR_NetCDF_RAF_filename
        product = NCAR_NetCDF_RAF()
    ...
    def test_WHEN_file_dose_not_exist_THEN_errors(self):
        from jasmin_cis.test.test_files.integration_test_data import invalid_filename
        product = NCAR_NetCDF_RAF()
    ...
    def test_WHEN_file_is_not_NCAR_RAF_OR_GASSP_THEN_errors(self):
        from jasmin_cis.test.test_files.integration_test_data import valid_hadgem_filename
        product = NCAR_NetCDF_RAF()
    ...
    def test_WHEN_file_is_not_netcdf_THEN_errors(self):
        from jasmin_cis.test.test_files.integration_test_data import valid_aeronet_filename
        product = NCAR_NetCDF_RAF()
