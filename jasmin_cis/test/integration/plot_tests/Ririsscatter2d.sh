...
cis plot rain:${source_dir}xglnwa.pm.k8dec-k9nov.vprof.tm.nc:itemstyle=^ --type scatter --title overiddentitle --fontsize 10 --width 7 --itemwidth 300 --ymin=-0.0005 --ymax 0.0005 --output "O$SUBJECT.png"
