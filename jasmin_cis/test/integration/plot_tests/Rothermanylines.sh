...
cis plot AOT_440:${source_dir}920801_091128_Agoufou_small.lev20:color=green,itemstyle=dotted AOT_870:${source_dir}920801_091128_Agoufou_small.lev20:itemstyle=dashed AOT_1020:${source_dir}920801_091128_Agoufou_small.lev20:color=red --type line --ylabel overiddenylabel --itemwidth 2 --ymin 0.1 --ymax 1 --logx --logy --output "O$SUBJECT.png"
