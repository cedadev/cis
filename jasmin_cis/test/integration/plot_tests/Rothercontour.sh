...
cis plot RVOD_liq_water_content:${source_dir}2007180125457_06221_CS_2B-CWC-RVOD_GRANULE_P_R04_E02.hdf:cmap=RdBu --type contour --ylabel overiddenylabel --title overiddentitle --vmin 0 --cbarorient vertical --grid --xaxis Latitude --yaxis Height --output "O$SUBJECT.png"
