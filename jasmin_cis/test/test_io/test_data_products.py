...
def get_data_accepts_valid_product():
    get_data('Cloudsat_2B_CWC_RVOD', valid_cloudsat_RVOD_file, valid_cloudsat_RVOD_variable)

@istest
@raises(NotImplementedError)
def get_data_throws_NotImplementedError_for_missing_product():
    get_data('Cloudsat_NotYetImplemented', valid_cloudsat_RVOD_file, valid_cloudsat_RVOD_variable)
...
def get_data_throws_TypeError_for_invalid_product():
    ...
    get_data('My_test_product', valid_cloudsat_RVOD_file, valid_cloudsat_RVOD_variable)