...
cis plot rain:${source_dir}xglnwa.pm.k8dec-k9nov.col.tm.nc:cmap=RdBu snow:${source_dir}xglnwa.pm.k8dec-k9nov.col.tm.nc:label=snowlabel,cmap=RdBu --type scatter --fontsize 7 --cbarorient vertical --grid --ymin 0 --ymax 90 --vmin 0 --cbarorient vertical --output "O$SUBJECT.png"
