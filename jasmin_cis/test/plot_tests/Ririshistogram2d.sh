...
cis plot rain:${source_dir}xglnwa.pm.k8dec-k9nov.vprof.tm.nc:red:step:overridenlabel snow:${source_dir}xglnwa.pm.k8dec-k9nov.vprof.tm.nc:green:step --type histogram2d --xmin=-50 --xmax 50 --xbinwidth 10 --ymin 1 --logy --output "O$SUBJECT.png"
