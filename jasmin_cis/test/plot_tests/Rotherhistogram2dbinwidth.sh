...
cis plot AOT_440:${source_dir}920801_091128_Agoufou_small.lev20::step AOT_870:${source_dir}920801_091128_Agoufou_small.lev20::step --type histogram2d --xstep 0.5 --output "O$SUBJECT.png"
