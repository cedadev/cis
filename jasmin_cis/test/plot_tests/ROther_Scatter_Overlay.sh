...
. "$ROOT_HARNESS_DIR/CommonSetupAndBuildFunctions.sh"
# Build test harness executable and setup for run.
SetupAndCompileTest
########################################
