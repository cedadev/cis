...
cis plot rain:${source_dir}xglnwa.pm.k8dec-k9nov.vprof.tm.nc snow:${source_dir}xglnwa.pm.k8dec-k9nov.vprof.tm.nc --type histogram3d --cmap RdBu --ylabel overiddeny --title overiddentitle --xmin=-50 --xmax 40 --ystep 10 --vmin 3 --vstep 1 --output "O$SUBJECT.png"
