...
def step_over_diffs():
    import cis.test.integration.plot_tests
    image_dir = os.path.join(os.path.dirname(cis.test.integration.plot_tests.__file__),
                             'reference', 'visual_tests')
    diff_dir = os.path.join(os.path.dirname(cis.test.integration.plot_tests.__file__),
