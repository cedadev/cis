...
class TestFullAverage(unittest.TestCase):
    def test_basic_col_in_4d(self):
        from cis.col_implementations import GeneralUngriddedColocator, moments, DummyConstraint
...
class TestNNGridded(unittest.TestCase):
    def test_basic_col_gridded_to_ungridded_in_2d(self):
        from cis.col_implementations import GeneralUngriddedColocator, nn_gridded, DummyConstraint
...
class TestNNHorizontal(unittest.TestCase):
    def test_basic_col_in_2d(self):
        from cis.col_implementations import GeneralUngriddedColocator, nn_horizontal, DummyConstraint
...
class TestNNTime(unittest.TestCase):
    def test_basic_col_with_incompatible_points_throws_a_TypeError(self):
        from cis.col_implementations import GeneralUngriddedColocator, nn_time, DummyConstraint
...
class TestNNAltitude(unittest.TestCase):
    ...
    def test_basic_col_with_incompatible_points_throws_a_TypeError(self):
        from cis.col_implementations import GeneralUngriddedColocator, nn_altitude, DummyConstraint
...
class TestNNPressure(unittest.TestCase):
    ...
    def test_basic_col_with_incompatible_points_throws_a_TypeError(self):
        from cis.col_implementations import GeneralUngriddedColocator, nn_pressure, DummyConstraint
...
class TestMean(unittest.TestCase):
    ...
    def test_basic_col_in_4d(self):
        from cis.col_implementations import GeneralUngriddedColocator, mean, DummyConstraint
        import datetime as dt
...
class TestLi(unittest.TestCase):
    ...
    def test_basic_col_gridded_to_ungridded_using_li_in_2d(self):
        from cis.col_implementations import GeneralUngriddedColocator, li, DummyConstraint
