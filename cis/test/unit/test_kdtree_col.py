...
from cis.col_implementations import (GeneralUngriddedColocator, nn_horizontal_kdtree, DummyConstraint,
                                            SepConstraintKdtree, make_coord_map)
from cis.haversinedistancekdtreeindex import HaversineDistanceKDTreeIndex
from cis.kdtree import KDTree
...
class TestSepConstraintWithoutHorizontalSeparation(object):
    ...
    def test_alt_constraint_in_4d(self):
        from cis.col_implementations import SepConstraintKdtree
        import datetime as dt
        import numpy as np
