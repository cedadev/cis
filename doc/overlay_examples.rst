...
::
  ...
  cis plot od550aer:cis-HadGEM_od550aer-subset.nc:product=NetCDFGriddedByVariableName,cmap=Reds,type=contourf,alpha=0.5,cmin=0.15 --type overlay --plotwidth 20 --plotheight 15 --cbarscale 0.5 --nasabluemarble
